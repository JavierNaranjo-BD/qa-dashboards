# Latest PR QA dashboards

Esta página agrupa los últimos resultados publicados para ejecuciones de tipo **PR**.
...
### pact
- [Ver summary](../latest/front-customer-workspace/pact/pr/summary.html)
- [Ver summary.json](../latest/front-customer-workspace/pact/pr/summary.json)
- [Ver results.json](../latest/front-customer-workspace/pact/pr/artifacts/results.json)
- [Ver Playwright report](../latest/front-customer-workspace/pact/pr/artifacts/playwright-report/index.html)
